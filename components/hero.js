...
const Hero = () => {
  ...
  <div className="w-full h-full lg:h-screen lg:pt-10 relative lg:bg-burnt-orange lg:w-1/4 lg:fixed snap-start animate-fade-in-left">
    ...
    <img className="h-40 md:h-46  xl:h-64 rounded-none mx-auto drop-shadow" src="/profile-photo.png" />
    <div>
      ...
      <div className='flex justify-center mx-2'>
        <Link href='#contact'>
          <button type='button' className='bg-primary btn inline-flex cursor-pointer transform shadow-lg hover:shadow-2xl hover:-translate-y-1 active:outline-none active:translate-y-0 active:shadow-lg focus:outline-none'>
